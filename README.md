...
(Intel AI PC Skills release 1.0.9.1) are **already published** — `learning-bot -Resolve <key>` maps an
...
[AI PC Skills 1.0.9.1 release](https://github.com/makejiang/aipc-skills/releases/tag/1.0.9.1) and unzips
